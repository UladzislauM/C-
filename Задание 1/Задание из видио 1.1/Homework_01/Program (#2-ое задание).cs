    ...
    class Program
    {
        static void Main(string[] args)
        {
           // Создание базы данных из 40 сотрудников
            Repository repository = new Repository(Count: 40);
            ...
            // Увольнение всех работников с именем "Агнес" - не разобрался как увольнять по фамилии. В коде ведь просто "ByName".
